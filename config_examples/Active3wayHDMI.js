...
settings.sink = {
    ...
    ecasound: `export LADSPA_PATH=/usr/local/lib/ladspa:/usr/lib/ladspa; stdbuf -i0 -o0 -e0  ecasound -B:rt -z:mixmode,sum -z:nodb -b:ecasound_buffer_size  -a:woofer,mid,tweeter -f:16,2,44100 -i stdin -a:woofer -pf:woofer.ecp -chorder:1,2,0,0,0,0,0,0 \ -a:mid -pf:mid.ecp -chorder:0,0,1,2,0,0,0,0 \ -a:tweeter -pf:tweeter.ecp -chorder:0,0,0,0,0,0,1,2 \ -a:woofer,mid,tweeter -f:s16,8,44100 -o:stdout`,
    outputChannels: 8,
