...
settings.sink = {
    ...
    ecasound: `export LADSPA_PATH=/usr/local/lib/ladspa:/usr/lib/ladspa; stdbuf -i0 -o0 -e0  ecasound -z:mixmode,sum -x -z:nodb -b:ecasound_buffer_size \
    -a:pre1 -f:16,2,44100 -i stdin \
    -pf:pre1-3way.ecp -o:loop,1 \
