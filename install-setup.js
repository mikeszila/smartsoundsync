...
if (!stopOnly) {
    ...
    let dependenciesspdif = ['lirc', 'evtest', 'python3-pip', 'libxslt1-dev', 'libxml2-dev', 'zlib1g-dev', 'python3-lxml', 'python-lxml', 'libxml2-dev', 'libxslt1-dev', 'python-dev', 'libasound2-dev']
